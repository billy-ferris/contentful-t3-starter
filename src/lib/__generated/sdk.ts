...
/** Full-width container for creating visually distinct Calls-to-Action (CTAs) [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/componentCta) */
...
/** Full-width container for displaying side-by-side image and copy, includes multiple layout options [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/componentDuplex) */
...
/** Full-width container for displaying images and snappy copy; can include an optional CTA [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/componentHeroBanner) */
...
/** Full-width container for displaying short bits of generic information with optional icons/visuals [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/componentInfoBlock) */
...
/** Component that renders products in a table enabling a side-by-side comparison [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/componentProductTable) */
...
/** Full-width component for quotes, reviews and testimonials, includes multiple layout options [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/componentQuote) */
...
/** Constrained-width component for displaying ad-hoc paragraphs of text (FAQs, intros, descriptions) [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/componentTextBlock) */
...
/** Navigation content type used for powering the Footer menu [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/footerMenu) */
...
/** A group of items making up a section in the navigation menu [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/menuGroup) */
...
/** Navigation menu in the header [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/navigationMenu) */
...
/** Container that enables editors to publish a page, define its slug, select & arrange its content [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/page) */
...
/** Open Graph (OG) meta tags for optimizing SEO visibility [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/seo) */
...
/** Container for ever-green content like About us, Career pages, FAQ, Knowledge base & more [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/topicBusinessInfo) */
...
/** Container for holding info about people (article authors, company leadership, quoted customers, etc.) [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/topicPerson) */
...
/** Container for product-specific information like card definitions, features, benefits, prices & more [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/topicProduct) */
...
/** Sub-container for product features enabling re-use of generic features across different products [See type definition](https://app.contentful.com/spaces/yt1f71dxn054/content_types/topicProductFeature) */
...
export type HeroBannerFieldsFragment = { __typename: 'ComponentHeroBanner', headline?: string | null, sys: { __typename?: 'Sys', id: string } };
...
export const HeroBannerFieldsFragmentDoc = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    heroBanner(variables: HeroBannerQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<HeroBannerQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<HeroBannerQuery>(HeroBannerDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'heroBanner', 'query', variables);
    }
  };
}
